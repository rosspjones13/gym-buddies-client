    ...
    return (
      <div>
        ...
        <Modal
          ...
          onCancel={() =>
            this.setState({ modalVisible: false, exerciseCategory: {} })
          }
        >
          <Row>
            <Col span={22} offset={1}>
              <Radio.Group buttonStyle="outline" onChange={this.onRadioChange}>
...
const mapDispatchToProps = (dispatch) => {
  return {
    postNewWorkout: (newWorkout) => {
      dispatch(postNewWorkout(newWorkout));
    },
    updateUserWorkouts: (newWorkout, exercise) => {
      dispatch(updateUserWorkouts(newWorkout, exercise));
    },
  };
};
